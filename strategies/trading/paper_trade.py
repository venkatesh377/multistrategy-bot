...
class PaperTrader:
    def __init__(self, start_budget):
        ...
        self.active = None  # (pair, action, entry_price, amount, sl, tp)

    def has_active_trade(self):
        return self.active is not None

    def execute_trade(self, pair, action, entry_price):
        sl = round(entry_price * 0.97, 2)  # 3% SL
        tp = round(entry_price * 1.05, 2)  # 5% TP
    ...
    def save_state(self):
        ...
        # ✅ Simulated TEST-INR trade logic (no fetch)
